			...
			<div class="flex space-x-4 mt-8">
				<div class="w-4/6 md:w-1/2">
					...
					<div class="mt-4">
						...
						<button class="bg-white px-4 py-2 md:px-6 md:py-3 rounded-full text-[10px] text-xs lg:text-sm font-mono border border-gray-300 hover:bg-cool-grey" on:click={scrollToSection}>
